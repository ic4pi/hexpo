...
All three readings and all three spell jars currently have live Stripe
Price IDs wired in (verified against the connected Stripe account) — no
missing entries as of this writing.
